  ...
  return (
    <nav className="navbar fixed-top navbar-expand-lg px-5 d-flex align-items-start ">
      ...
      <Link className="navbar-brand mt-4" href="/">
        <Image src={"/OptimasLogo.png"} width={170} height={80} objectFit="contain" alt="optimas brang logo in orange for navbar. click to redirect to homepage" />
      </Link>
      <button
      ...
      <div
        className="collapse navbar-collapse justify-content-around mt-5"
