...
export default function Home() {
  return (
    ...
    <div>
      ...
      <Script id="next js script" src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js" integrity="sha384-IQsoLXl5PILFhosVNubq5LC7Qb9DXgDA9i+tQ8Zj3iwWAwPtgFTxbJ8NT4GN1R8p" crossorigin="anonymous">
        </Script>
<Script id="next js script" src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></Script>
      ...
      <div className="container my-3 pb-5">
        {/* <div className=""> */}
          <h1>Our Partners & Clients Include</h1>
        {/* </div> */}
        ...
        <div className="m-5 p-5d-flex justify-content-center" align="center">
          <div className="row align-items-center">
            ...
            className="col"
              ...
              rel="noopener noreferrer"
            >
              <Image src={"/brands/RTB.png"} width={112} height={95} alt="r t b logo"/>
            </a>
            <a
            className="col"
              target="_blank"
              ...
              rel="noopener noreferrer"
            >
              <Image src={"/brands/iPSB-tech.png"} width={143} height={78} alt="i p s b logo"/>
            </a>
            <a
            className="col"
              target="_blank"
          ...
          <div className="row align-items-center">
            ...
            className="col"
              ...
              rel="noopener noreferrer"
            >
              <Image src={"/brands/cbtl.png"} width={89} height={90} alt="coffee bean tea leaf logo"/>
            </a>
            <a
            className="col"
              target="_blank"
            ...
            className="col"
              ...
              rel="noopener noreferrer"
            >
              <Image src={"/brands/Nissan.png"} width={97} height={97} alt="nissanlogo"/>
            </a>
            <a
            className="col"
              target="_blank"
              ...
              rel="noopener noreferrer"
            >
              <Image src={"/brands/Omni-Sports.png"} width={162} height={161} alt="omni sports logo" />
            </a>
            <a
            className="col"
              target="_blank"
              ...
              rel="noopener noreferrer"
            >
              <Image src={"/brands/Progresif.png"} width={162} height={161} alt="progresiflogo" />
            </a>
            <a
            className="col"
              target="_blank"
              ...
              rel="noopener noreferrer"
            >
              <Image src={"/brands/thescoop.png"} width={150} height={149} alt="the scoop logo"/>
            </a>
            <a
            className="col"
              target="_blank"
